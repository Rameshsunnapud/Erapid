...
String url4="http://"+ application.getInitParameter("HOST")+"/erapid/us/orders/ows/credit_card_form.jsp?order_no="+order_no;
//http://"+ application.getInitParameter("HOST")+"/custom/orders/ows/credit_card_form.jsp?order_no="+order_no;
...
if(rs2 != null){
	while(rs2.next()){
		...
		if(rs2.getString("product_id").equals("ADS")&& rs2.getString("quote_origin")!=null && (rs2.getString("quote_origin").equals("As Build")||rs2.getString("quote_origin").equals("change")||rs2.getString("quote_origin").equals("release")||rs2.getString("quote_origin").equals("revision")||rs2.getString("quote_origin").equals("submittal"))){
			sendpdf=false;
		}
	}
}
rs2.close();
out.println(creator_id+"<BR>");

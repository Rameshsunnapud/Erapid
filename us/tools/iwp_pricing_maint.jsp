...
out.println(" <center><font color='336699' size='3'><b>WELCOME TO IWP MAINTENANCE</b></font><center>");
...
String columnNames[][] = new String[1][34];
...
tableName[0]="CS_IWP_PRICING";
specificWhere[0]=" ";
columnNames[0][0]="MODEL";
columnNames[0][1]="BPCS";
columnNames[0][2]="L4_MU";
columnNames[0][3]="L5_MU";
columnNames[0][4]="L6_MU";
columnNames[0][5]="L4_PRICE";
columnNames[0][6]="L5_PRICE";
columnNames[0][7]="L6_PRICE";
columnNames[0][8]="ADJ4";
columnNames[0][9]="ADJ5";
columnNames[0][10]="ADJ6";
columnNames[0][11]="UM";
columnNames[0][12]="PROD";
columnNames[0][13]="WGT";
columnNames[0][14]="LIST_PRICE";
columnNames[0][15]="DISC";
columnNames[0][16]="DISC_TBL";
columnNames[0][17]="COM_TBL";
columnNames[0][18]="CHAM";
columnNames[0][19]="LTQTY";
columnNames[0][20]="GTQTY";
columnNames[0][21]="COST";
columnNames[0][22]="DECOLINK";
columnNames[0][23]="DECOLINK_MU";
columnNames[0][24]="EFFECTIVE_DATE";
columnNames[0][25]="INACTIVE";
columnNames[0][26]="DESCRIPTION";
columnNames[0][27]="IC_STOCK";
columnNames[0][28]="IC_STD";
columnNames[0][29]="L7_PRICE";
columnNames[0][30]="L8_PRICE";
columnNames[0][31]="L9_PRICE";
columnNames[0][32]="L10_PRICE";
columnNames[0][33]="PB";
keys[0][0]="MODEL";


out.println("<form name='form1' action='iwp_pricing_maint.jsp'>");
...
if(mode != null && mode.equals("tablePreview")&&table!=null&&!table.equals("null")){
	...
	if(rs1 != null){
		while(rs1.next()){
			...
			key="iwp_pricing_maint.jsp?table="+table+key;
	...
	out.println("<form name='editForm' action='iwp_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave'  action='iwp_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave' onsubmit='iwp_pricing_maint.jsp'>");
	out.println("<input type='hidden' name='mode' value='reset'>");
	out.println("<input type='hidden' name='table' value='"+table+"'>");
	out.println("<div id='test' style='position: absolute; left: 10px; top: 200px; height: 400px; width: 800px; padding: 1em '>");
	int x=Integer.parseInt(table);

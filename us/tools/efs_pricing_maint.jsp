...
out.println(" <center><font color='336699' size='3'><b>WELCOME TO EFS MAINTENANCE</b></font><center>");
...
String columnNames[][] = new String[1][22];
...
tableName[0]="CS_EFS_PRICING";
specificWhere[0]=" ";
columnNames[0][0]="MODEL";
columnNames[0][1]="BOOK";
columnNames[0][2]="DESCRIPTION";
columnNames[0][3]="L10";
columnNames[0][4]="L15";
columnNames[0][5]="L22";
columnNames[0][6]="COST";
columnNames[0][7]="MULTIPLIER";
columnNames[0][8]="EFFECTIVE_DATE";
columnNames[0][9]="PROD";
columnNames[0][10]="INACTIVE";
columnNames[0][11]="UM";
columnNames[0][12]="UNIT_WEIGHT";
columnNames[0][13]="IC_STOCK";
columnNames[0][14]="IC_STD";
columnNames[0][15]="L3_PRICE";
columnNames[0][16]="L5_PRICE";
columnNames[0][17]="L6_PRICE";
columnNames[0][18]="L7_PRICE";
columnNames[0][19]="L8_PRICE";
columnNames[0][20]="L9_PRICE";
columnNames[0][21]="L10_PRICE";
keys[0][0]="MODEL";


out.println("<form name='form1' action='efs_pricing_maint.jsp'>");
...
if(mode != null && mode.equals("tablePreview")&&table!=null&&!table.equals("null")){
	...
	if(rs1 != null){
		while(rs1.next()){
			...
			key="efs_pricing_maint.jsp?table="+table+key;
	...
	out.println("<form name='editForm' action='efs_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave'  action='efs_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave' onsubmit='efs_pricing_maint.jsp'>");
	out.println("<input type='hidden' name='mode' value='reset'>");
	out.println("<input type='hidden' name='table' value='"+table+"'>");
	out.println("<div id='test' style='position: absolute; left: 10px; top: 200px; height: 400px; width: 800px; padding: 1em '>");
	int x=Integer.parseInt(table);

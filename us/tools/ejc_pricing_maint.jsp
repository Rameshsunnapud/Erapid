<html>
<head>
<title>Muncy Pricing Maint</title>
...
out.println(" <center><font color='336699' size='3'><b>WELCOME TO EJC MAINTENANCE</b></font><center>");
...
String columnNames[][] = new String[1][39];
String keys[][] = new String[1][1];//if number of keys changes, you will have to add more input to the filter boxes
int numColumns[] = new int[1];


tableName[0]="CS_EJC_PRICING";
specificWhere[0]=" ";
columnNames[0][0]="MODEL";
columnNames[0][1]="WIDTH";
columnNames[0][2]="DEPTH";
columnNames[0][3]="DESCRIPTION";
columnNames[0][4]="WEIGHT";
columnNames[0][5]="BOOK";
columnNames[0][6]="INT_WEIGHT";
columnNames[0][7]="INT_PRICE";
columnNames[0][8]="BR";
columnNames[0][9]="SS";
columnNames[0][10]="CU";
columnNames[0][11]="UOM";
columnNames[0][12]="LS";
columnNames[0][13]="PER";
columnNames[0][14]="VD";
columnNames[0][15]="VB";
columnNames[0][16]="FB1";
columnNames[0][17]="FB2";
columnNames[0][18]="FB2L";
columnNames[0][19]="FB3";
columnNames[0][20]="FB4";
columnNames[0][21]="STYLE";
columnNames[0][22]="GRP";
columnNames[0][23]="SERIES";
columnNames[0][24]="ENV";
columnNames[0][25]="TYPE";
columnNames[0][26]="COST";
columnNames[0][27]="EFFECTIVE_DATE";
columnNames[0][28]="INACTIVE";
columnNames[0][29]="IC_STOCK";
columnNames[0][30]="IC_STD";
columnNames[0][31]="L3_PRICE";
columnNames[0][32]="L5_PRICE";
columnNames[0][33]="L6_PRICE";
columnNames[0][34]="L7_PRICE";
columnNames[0][35]="L8_PRICE";
columnNames[0][36]="L9_PRICE";
columnNames[0][37]="L10_PRICE";
columnNames[0][38]="PROD";
keys[0][0]="MODEL";

out.println("<form name='form1' action='ejc_pricing_maint.jsp'>");
...
if(mode != null && mode.equals("tablePreview")&&table!=null&&!table.equals("null")){
	...
	if(rs1 != null){
		while(rs1.next()){
			...
			key="ejc_pricing_maint.jsp?table="+table+key;
	...
	out.println("<form name='editForm' action='ejc_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave'  action='ejc_pricing_maint.jsp'>");
	...
	out.println("<form name='editSave' onsubmit='ejc_pricing_maint.jsp'>");
	out.println("<input type='hidden' name='mode' value='reset'>");
	out.println("<input type='hidden' name='table' value='"+table+"'>");
	out.println("<div id='test' style='position: absolute; left: 10px; top: 200px; height: 400px; width: 800px; padding: 1em '>");
	int x=Integer.parseInt(table);

...
<html>
	<head>
		...
		<title>Work Copy # <%= request.getParameter("orderNo") %> </title>
	...
	<body>
		...
		ResultSet rs1=stmt.executeQuery("select project_type,product_id from cs_project where order_no='"+order_no+"'");
		if(rs1 != null){
			while(rs1.next()){
...
if(product.equals("ADS")){
		%>
		<jsp:forward page="show_summary_sfdc2.jsp">
		...
		%>
		<jsp:forward page="show_summary_sfdc3.jsp">
			<jsp:param name="order_no" value="<%= order_no %>" />
			<jsp:param name="pid" value="<%= 3 %>" />
			<jsp:param name="nowc" value="<%= 1 %>" />
		</jsp:forward>
		...
		%>
		<jsp:forward page="show_summary_sfdc.jsp">
			<jsp:param name="order_no" value="<%= order_no %>" />
			<jsp:param name="pid" value="<%= 3 %>" />
			<jsp:param name="nowc" value="<%= 1 %>" />
		</jsp:forward>
		...
		%>
		<jsp:forward page="show_summary_ejc.jsp">
			<jsp:param name="order_no" value="<%= order_no %>" />
			<jsp:param name="pid" value="<%= 3 %>" />
			<jsp:param name="nowc" value="<%= 1 %>" />
		</jsp:forward>

...
else if(product.endsWith("LVR")|product.equals("REP_LVR"))  {
if(product.endsWith("LVR")){product="LVR";}
double sp_factor=0;double l_cost=0;


String pro_temp	="";
Vector products=new Vector();
ResultSet rsProduct=stmt.executeQuery("select distinct product_id from cs_costing where order_no ='"+order_no+"'");
if(rsProduct != null){
...
ResultSet myResult_factor=stmt.executeQuery("select * from cs_lvr_sp_factor where com_percent='"+commission+"' and product_id='"+pro_temp+"' ");
...
//out.println("Test"+commission+"::"+l_cost);
%>
<%@ include file="show_summary_body_lvr.jsp"%>
<%

<table width='100%' border='0' cellpadding='0' cellspacing='0' class='test1'>
	<tr><td>
			<table width='100%' class='test'>
				...
				<tr>
					<td class='boxl' width='19%'><%= ins_style_group.elementAt(m) %>&nbsp;</td>
					<td class='box' width='28%'><%= ins_col_group.elementAt(m) %>&nbsp;</td>
					<td class='box' width='28%'><%= cat_no_group.elementAt(m) %>&nbsp;</td>
					<td class='box' width='3%'><%= part_no_group.elementAt(m) %>&nbsp;</td>

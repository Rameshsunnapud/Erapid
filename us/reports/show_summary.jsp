...
if (rs_eorders !=null) {
        while (rs_eorders.next()) {
			if(rs_eorders.getString(1)!=null){
				edate= rs_eorders.getString(1).substring(0,10);
			}
		
		if(rs_eorders.getString(2)!=null){
...
else if(product.equals("IWP")||product.equals("ADS"))  {
if((st.equals("2")|st.equals("3"))){
 //out.println("HERE1<BR>");
%>
<%@ include file="show_fact_summary_body_iwp.jsp"%>
<%
}
else {
//out.println("HERE2<BR>");
%>
<%@ include file="show_summary_body_iwp.jsp"%>
<%
}
}

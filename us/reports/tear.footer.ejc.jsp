<tr><td>
		<table width='100%' border='0' cellpadding='0' cellspacing='0' class='test'>
			<tr>
				...
				<td align='center' width='9%' class='boxl'>MOVEMENT (%)</td>
				<td align='center' width='8%' class='boxl'>LATERAL<BR>SHEAR</td>
				<td align='center' width='8%' class='boxl'>VERT.<BR>DEFLECTION</td>
				...
				<td align='center' valign='top' rowspan='6' colspan='1' class='boxrb'>
					<table class='test' cellpadding='0' cellspacing='0' border='1'><tr><td valign='top' width='8%' colspan='3' class='boxltr'>PROJECT: <%= pname %></td></tr>
						<tr><td valign='top' colspan='3' width='8%' class='boxltr'>LOCATION:<%= ploc %></td></tr>
						<tr><td valign='top' colspan='3' width='8%' class='boxltr'>CONTRACTOR: <%= cust_name1 %></td></tr>
						<tr><td valign='top' colspan='2' width='4%' class='boxlt'>AGENT: <%= pagent %></td>
							<td valign='top' colspan='1' width='4%' class='boxltr'>TEAR SHEET:<%= m+1 %> </td> </tr>
						<tr><td colspan='3'>
								<table class='test' cellpadding='0' cellspacing='0'><tr>

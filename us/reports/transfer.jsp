...
<%
			...
			//
			String dir_path="D:\\TRANSFER\\BPCS_BOM\\";String final_out="";String final_notes_out="";
			String dir_path1="D:\\TRANSFER\\BPCS_BOM\\test\\";
//			out.println("Let's see....OK.................<br>"+"Check the out put in"+dir_path+" for the BOM upload files"+"<br><br><br>");
			ResultSet rs_find = stmt.executeQuery("SELECT * FROM cs_bpcs_mat_shop_orders where cse_order_no like '"+order_no+"' and transfer='Y' and prod_desc <> 'misc' order by bpcs_shop_order_no ");
			if (rs_find !=null) {
			while (rs_find.next()){
			...
			seq_no.addElement(rs_find.getString ("seq_no"));
			counter++;
			}
			}
...
//								final_out="";
								final_out=final_out+county+"MU"+t3+t1+t4+"0000"+"  "+"N"+"2 "+"000000"+order_no+erapid_line_no+"00000"+"000"+" "+parent_qty+"\r\n";
...
//								 out.write("out put done "+"<br>");
	//	 						 out.flush();
		...
		BufferedWriter out1 = new BufferedWriter(new FileWriter(dir_path+"\\"+"B"+order_no+".txt"));
								 out1.write(final_out);
//								 out.write("out put done "+"<br>");
		 						 out.flush();
								 out1.flush();
								 out1.close();
							 BufferedWriter out3 = new BufferedWriter(new FileWriter(dir_path1+"\\"+"B"+order_no+".txt"));
...
/*
int ikea=0;int counter12=0;//final_out="";
...
*/
			...
			dir_path="D:\\TRANSFER\\BPCS_ROU\\";final_out="";
			dir_path1="D:\\TRANSFER\\BPCS_ROU\\test\\";
...
//														        out.println("N"+k1+k2_notes+k3+k4+notes_4+notes_5+notes_6+notes_7+"MU   "+"<br>");
					   ...
					   //writing to the text
//						BufferedWriter out1 = new BufferedWriter(new FileWriter(dir_path+"\\"+"R"+order_no+".txt"));
//						out1.write(final_out);

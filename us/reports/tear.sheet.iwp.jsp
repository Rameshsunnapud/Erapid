<html>
	...
	<body>
		<%
/*
		if(pid.equals("1")&&(rep_quote.equals("2")||rep_quote.equals("4"))){
		%>
		<jsp:include page="tearsheet_waiver.jsp" flush="true">
	...
	if (count_line>0){
		    for (int m=0;m<count_group;m++){ //OUTer for loop bEGIN
			 ...
			 if (count_no_page<=0) {
									count_no_page++;
		%>
		<%@ include file="tear.head.iwp.jsp"%>
		<%@ include file="tear.footer.iwp.jsp"%>
		<%
//		 out.println("The quantity"+new Double(qty.elementAt(n).toString()).intValue());
				    //four line loop
						    out.println("<tr>");
						    if(rep_tear_sheet.equals("2") || rep_quote.equals("1")){
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+new Double(qty.elementAt(n).toString()).intValue()+"&nbsp;</td>");
						    }
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+finish.elementAt(n)+"&nbsp;</td>");
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;' >"+mark.elementAt(n)+"&nbsp;</td>");
						    out.println("<td align='center' valign='middle' width='9%' style='border-right: 1px solid;border-bottom: 1px solid;' colspan='2'>"+location.elementAt(n)+"&nbsp;</td>");
						    out.println("<td align='center' valign='middle' width='9%' style='border-right: 1px solid;border-bottom: 1px solid;' colspan='2'>"+model.elementAt(n)+"&nbsp;</td>");
						    ...
						    out.println("<td align='center' valign='middle' width='25%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+notes.elementAt(n)+"&nbsp;</td>");
						    out.println("</tr>");
				    //four line loop end
								 }	// count.no.page
	    else{
...
//out.println("The count"+count_no_page);
						    ...
						    out.println("<tr>");
						    if(rep_tear_sheet.equals("2") || rep_quote.equals("1")){
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+"&nbsp;"+"</td>");
						    }
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+"&nbsp;"+"</td>");
						    out.println("<td align='center' valign='middle' width='5%' style='border-right: 1px solid;border-bottom: 1px solid;' >"+"&nbsp;"+"</td>");
						    out.println("<td align='center' valign='middle' width='9%' style='border-right: 1px solid;border-bottom: 1px solid;' colspan='2'>"+"&nbsp;"+"</td>");
						    out.println("<td align='center' valign='middle' width='9%' style='border-right: 1px solid;border-bottom: 1px solid;' colspan='2'>"+"&nbsp;"+"</td>");
						    //out.println("<td align='center' valign='middle' width='8%' class='boxlt'>"+"&nbsp;"+"</td>");
						    //out.println("<td align='center' valign='middle' width='8%' class='boxlt'>"+"&nbsp;"+"</td>");

						    out.println("<td align='center' valign='middle' width='25%' style='border-right: 1px solid;border-bottom: 1px solid;'>"+"&nbsp;"+"</td>");
						    out.println("</tr>");
															    }
										    }
							    out.println("</table></td></tr></table>");

	...
	if(rsSf != null){
		while(rsSf.next()){
			...
			if(rsSf.getString("Street_Name__c")!=null && !rsSf.getString("Street_Name__c").equals("null") && rsSf.getString("Street_Name__c").trim().length()>0){
				repAddress=repAddress+rsSf.getString("Street_Name__c");
				
				if(rsSf.getString("Floor_or_House_Number__c")!=null && !rsSf.getString("Floor_or_House_Number__c").equals("null") && rsSf.getString("Floor_or_House_Number__c").trim().length()>0){
					repAddress=repAddress+" , "+rsSf.getString("Floor_or_House_Number__c");
				}
			}
...
*/
	...
	String note110="*PL4080*PL5700*PL4080 Glazing Frame*PL5700 Glazing Frame*";

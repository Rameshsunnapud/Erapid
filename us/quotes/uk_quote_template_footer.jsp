...
if((product.equals("EFS")||product.equals("IWP"))||(product.equals("EJC") && (sections<2||(section_page!=null&&section_page.equals("1"))))){
...
<Table width='100%'>
	...
	if(sections>1){
		...
		if (!(tax_perc==null||tax_perc.equals("0"))){
			if(product.equals("ELM")||product.equals("GE")){
				...
				%>
		<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%=for12x.format(grand_total1-new Double(freight_cost).doubleValue())  %></font>&nbsp;<%=currencyName%></b></td>
	</tr>
	<tr>
	...
	//out.println("HERE");
	%>
	<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%=for12x.format(grand_total1)  %></font>&nbsp;<%=currencyName%></b></td>
...
//out.println(price);
%>
<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%=for12x.format(new Double(price).doubleValue()) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
else{
...
%>
<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%=for12x.format(new Double(inittotal).doubleValue())  %></font>&nbsp;<%=currencyName%></b></td>
</tr>
...
<tr>
	...
	<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for12x.format(totalnew) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
	...
	if (!(tax_perc==null||tax_perc.equals("0"))){
		if(product.equals("IWP")||product.equals("EFS")||product.equals("GCP")||product.equals("ELM")||product.equals("GE")){
			...
			if((grandtotalforsec != null && grandtotalforsec.trim().length()>0)||product.equals("GCP")||product.equals("ELM")||product.equals("GE")){
				...
				if((new Double(grandtotalforsec).doubleValue()>0)){
...
out.println("<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>"+for1.format(grand_total1)+"</font>&nbsp;"+currencyName+"</b></td>");
out.println("</tr>");
...
<Table width='100%'>
	...
	<tr><td class='maindesc'>&nbsp;</td></tr>
	<tr><td class='maindesc'>5.  Prices are firm against escalation for 30 days from date of this quote, and for shipment within 90 days thereafter. Orders shipped beyond shall be subject to escalation of 0.5% per month or partial month thereafter and invoiced at time of shipment. </td></tr>
	<tr><td class='maindesc'>&nbsp;</td></tr>

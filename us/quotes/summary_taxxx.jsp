...
if (!(tax_perc==null||tax_perc.equals("0")||new Double(tax_perc).doubleValue()<=0)){
	...
	if(isquote.toLowerCase().equals("yes")){
		...
		if(product_id.equals("ADS")){
			...
			out.println("<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>"+for1ads.format(tax_dollar)+"&nbsp;</font></b></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("<table cellspacing='0' cellpadding='0' border='0' width='100%' height='25'><tr>");
			out.println("<td class='maindesc' width='50%' valign='middle'><b>Material and Tax Only </b></td>");
			out.println("<td class='maindesc' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>"+for1ads.format(grand_total)+"&nbsp;</font></b></td>");
			out.println("</tr>");

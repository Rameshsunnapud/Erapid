...
String cust_fax="";String cust_phone="";
                                ...
                                if ((ccode.equals("US") || ccode.equals("CA"))) {cust_no=cust_no.substring(2);}
                                        else {ccode="US";}
                                ...
                                while (rs_customers.next()) {
										...
										out.println("Customer ----- cust_name1"+cust_name1);
...
//out.println("select name,street_Name__c,City_or_Town__c,State_Province__c ,Postal_Code_or_Zip_Code__c,Country__c,phone,fax from account where id='"+sfdcAccount+"'<BR><BR>");
		ResultSet rsSfAccount2=stmt_sfdc.executeQuery("select name,street_Name__c,City_or_Town__c,State_Province__c ,Postal_Code_or_Zip_Code__c,Country__c,phone,fax from account where id='"+sfdcAccount+"'");
...
/*
out.println(cust_phone+":: cust phonE<BR>");
out.println(cust_fax+":: cust fax<BR>");
out.println(cust_name1+":: Cust name<BR>");
*/

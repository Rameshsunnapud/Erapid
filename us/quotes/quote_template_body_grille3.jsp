...
if(sections<=0){
	...
	if (t_group>0){
		for(int mn=0;mn<t_group;mn++){
			out.println("<table width='100%' class='table_thin_borders' cellspacing='1' cellpadding='0' border='1'>");
				...
				if((sskp_code_group.elementAt(mn).toString().equals(sskp_code.elementAt(n).toString()))&(model_group.elementAt(mn).toString().equals(model.elementAt(n).toString()))&(finish_group.elementAt(mn).toString().equals(finish.elementAt(n).toString()))
					...
					if ((n%2)==1){bgcolor="#EFEFDE";}else {bgcolor="#e4e4e4";}
						if(bcount==0){
	                            ...
	                            if(rsMount != null){
	                                while(rsMount.next()){
	                                    if(rsMount.getString(1)!=null&&rsMount.getString(1).length()>0){
	                                       out.println("<tr width='100%'><td colspan='7' class='mainbody'><b>Mount: </b>"+rsMount.getString(1)+"</td></tr>"); 
	                                    }
	                                }
	                            }
	                            rsMount.close();
                                ...
                                if(rsOutrigger != null){
                                    while(rsOutrigger.next()){
                                        if(rsOutrigger.getString(1)!=null&&rsOutrigger.getString(1).length()>0){
                                           out.println("<tr width='100%'><td colspan='7' class='mainbody'><b>Outrigger: </b>"+rsOutrigger.getString(1)+"</td></tr>"); 
                                        }
                                    }
                                }
                                rsOutrigger.close();
                                ...
                                if(rsBlades != null){
                                    while(rsBlades.next()){
                                        if(rsBlades.getString(1)!=null&&rsBlades.getString(1).length()>0){
                                           out.println("<tr width='100%'><td colspan='7' class='mainbody'><b>Blades to be: </b>"+rsBlades.getString(1)+"</td></tr>"); 
                                        }
                                    }
                                }
                                rsBlades.close();
                                ...
                                if(rsFrontFascia != null){
                                    while(rsFrontFascia.next()){
                                        if(rsFrontFascia.getString(1)!=null&&rsFrontFascia.getString(1).length()>0){
                                           out.println("<tr width='100%'><td colspan='7' class='mainbody'><b>Front Fascia to be: </b>"+rsFrontFascia.getString(1)+"</td></tr>"); 
                                        }
                                    }
                                }
                                rsFrontFascia.close();
                                ...
                                if(rsRearFascia != null){
                                    while(rsRearFascia.next()){
                                        if(rsRearFascia.getString(1)!=null&&rsRearFascia.getString(1).length()>0){
                                           out.println("<tr width='100%'><td colspan='7' class='mainbody'><b>Rear Fascia to be: </b>"+rsRearFascia.getString(1)+"</td></tr>"); 
                                        }
                                    }
                                }
                                rsRearFascia.close();
							...
							out.println("<table width='100%' class='table_thin_borders' cellspacing='1' cellpadding='2' border='1'>");
							...
							if(pidCsCosting.elementAt(n).toString().equals("LVR")) {
								...
								out.println("<td width='16%' bgcolor='#006600' class='schedule' align='center'><b><u>R.O. Size (W x H)</u></b></td>");
								
								if(tempmodel!=null&&(tempmodel.equals("RS7705"))){
									out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Recessed<br>Mullions</u></b></td>");
								}
	                            else if(tempmodel!=null&&tempmodel.equals("RS5700AL")){
									out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Mixed<br>Mullions</u></b></td>");
								}
								else if(tempmodel!=null&&tempmodel.equals("6155")){
									out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Semi-Recessed<br>Mullions</u></b></td>");
								}
								else{
									out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Exposed<br>Mullions</u></b></td>");
								}
								out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Sections per<BR>Louver(W X H)</u></b></td>");
								out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Shape</u></b></td>");
								out.println("<td width='14%' bgcolor='#006600' class='schedule' align='center'><b><u>System Depth<br>Including Supports</u></b></td>");
								out.println("<td width='10%' bgcolor='#006600' class='schedule' align='center'><b><u>Blank Off</u></b></td>");
								out.println("<td width='20%' bgcolor='#006600' class='schedule' align='center'><b><u>Sills</u></b></td>");
								out.println("</tr>");
								out.println("<tr>");
                                ...
                                if(pidCsCosting.elementAt(n).toString().equals("SUN")){  
                                   out.println("<td width='25%' bgcolor='#006600' class='schedule' align='center'><b><u>Runs</u></b></td>");
                                   out.println("<td width='25%' bgcolor='#006600' class='schedule' align='center'><b><u>Run size(Width x Projection)</u></b></td>");
                                   out.println("<td width='25%' bgcolor='#006600' class='schedule' align='center'><b><u>Factory Assembled Sections</u></b></td>");
                                   out.println("<td width='20%' bgcolor='#006600' class='schedule' align='center'><b><u>Location/Area</u></b></td></tr>");
                                   out.println("<tr>");
                                   out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'  align='center'>"+mark.elementAt(n).toString()+"</td>");
                                   out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc' align='center'>"+for12.format(new Double(qty.elementAt(n).toString()).doubleValue())+"</td>");
                                   out.println("<td valign='top' nowrap  nowrap bgcolor='"+bgcolor+"' class='maindesc' align='center'>"+width.elementAt(n).toString()+"' x "+height.elementAt(n).toString()+"'</td>");
			...
			out.println("<tr><td colspan='7' bolder='0'>"+"&nbsp;"+"</td></tr>");
			out.println("</table>");

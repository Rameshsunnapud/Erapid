...
//out.println(section_page+"::"+sections);
	if(product.equals("EFS")||((product.equals("EJC")||product.equals("IWP")||product.equals("GCP")||product.equals("APC"))&&((section_page != null && !section_page.equals("0")) || sections<=1))||product.equals("EJC")){
	...
	if(tax_perc != null && !tax_perc.equals("0") && !tax_perc.equals("0.0") && tax_perc.trim().length()>0){
		...
		if(overage != null && overage.trim().length()>0){
			...
			<tr>
				...
				<td width='35%' valign='bottom' class='mainbodyh'>&nbsp;</td></tr>
			<tr><td>..........................................................</td>
		...
		*/
			...
			<table cellspacing='0' cellpadding='0' border='0' width='100%'>
				...
				<tr><td class='mainfooter'>
						...
						%>
						<br>1. <%
	if(product.equals("GCP")){out.println("CS Cubicle Curtains Company");} else if(product.equals("GE")) {out.println("Construction Specialties");} else {out.println("CS");} %> Standard Terms and Conditions shall apply.
						<%

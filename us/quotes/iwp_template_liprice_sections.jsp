...
<table class='<%= border_color %>' cellspacing='0' cellpadding='0' border='0' width='100%' height='25'><tr>
		...
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%= for2dec.format(totprice-handlingX) %>&nbsp;<%=currencyName%></font></b></td>
				<%
			}
			else{
				%>
	...
	<tr>
		...
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%= for2dec.format(handlingX) %></font>&nbsp;<%=currencyName%></b></td>
	</tr>
	...
	<tr>
		...
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for2dec.format(totprice) %></font>&nbsp;<%=currencyName%></b></td>
	</tr>

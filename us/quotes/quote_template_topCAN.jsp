<table  width='100%' cellspacing='0' cellpadding='0' border='0'>
	<tr><td class='mainbodyh'>
			...
			else if ((product.equals("GE"))){out.println("The following price is based on furnishing the types, quantities, and sizes listed herein. If ultimate quantities or types deviate from those listed, price is subject to increase or decrease proportionately.<b> All PO's are to be made out to Construction Specialties.</b>");}
			else{
	...
	%>
	<tr><td width='70%' align='center' class='mainbodyh'>
			<table width='70%' cellspacing='0' cellpadding='0' border='0'>
				<tr>
					<td width='30%' class='mainbodyh'><b>Division:</b> <%= division %></td>
					<td width='30%' class='mainbodyh'><b>Section:</b> <%= section %></td>
					<%
	...
	%>
	<tr><td height="4" class="mainbodyh">&nbsp;&nbsp;</td></tr>
</table>

...
String price1="";String price="";String rep_notes=""; String tax_perc=""; String project_state2="";
// for formatting
...
for2.setMaximumFractionDigits(0);
 ...
 String supplyinstall="";
	...
	ResultSet rs_project = stmt.executeQuery("SELECT Project_name,currency,Job_loc,project_state,Arch_name,Arch_loc,Agent_name,Cust_name,product_id,section,division,free_text,overage,handling_cost,freight_cost,exclusions,len(exclusions)as v1,creator_id,exclusions_free_text,qualifying_notes,len(qualifying_notes) as v2,qualifying_notes_free_text,section_desc,project_type,rep_notes,tax_perc,setup_cost,supplyinstall,discount FROM cs_project where Order_no like '"+order_no+"'");
		...
		project_state2=project_state;
		//out.println(rs_project.getString("Project_state")+" from project<BR>");
		...
		supplyinstall=rs_project.getString("supplyinstall");
		discount=rs_project.getString("discount");

								}
							    }
if(supplyinstall== null){
	supplyinstall="";
}
...
if(Arch_name == null || Arch_name.equals("null")){
	Arch_name="";
}
if(Arch_loc == null || Arch_loc.equals("null")){
	Arch_loc="";
}
%>
<html>
...
String psa_spec_section_cdn="";
String psa_alternate="";String psa_addenda="";String psa_estimator="";String psa_rsm="";String bid_rsm="";
...
String project_id="";String psa_quote_type="";String psa_quote_notes="";String psa_type_of_quote="";String spec_level="";
		...
		//psa_spec_section_cdn=rs_psa_quotes.getString("spec_section");
...
rs_psa_quotes.close();
if(psa_spec_section_cdn != null&&psa_spec_section_cdn.trim().length()>0){
	if(psa_spec_section != null){
		psa_spec_section=psa_spec_section+" "+psa_spec_section_cdn;
	}
}
...
if(discount != null && !discount.equals("null") && discount.trim().length()>0){
	double discountperc=((100-new Double(discount).doubleValue())/100);
	tot_sum1=tot_sum1*discountperc;
	//out.println(tot_sum1+"::"+discountperc+"::<BR>");
}
...
//out.println(rep_no+"::"+psa_estimator);
...
String odate="";String doc_priority="";
  ...
  DateFormat dateformat = new SimpleDateFormat ("yyyy-MM-dd");
   ...
   java.util.Date date1= dateformat.parse(odate);
//out.println(odate+"<BR>");
//out.println(dateformat2.format(date1));
odate=""+dateformat2.format(date1);
//cs_quote_Sections
...
//			out.println("v "+desc_value1+"<br>");
	...
	%>
	<%@ include file="quote_template_header_psa_cdn.jsp"%>
	...
	%>
	<%@ include file="efs_template_body_psa.jsp"%>
	<%
}
	...
	%>
	<%@ include file="quote_template_nonconfig_body.jsp"%>
	<%
}
if((product.equals("IWP")||product.equals("SLM")||product.equals("EJC")||product.equals("EFS"))&&(section_page==null||((section_page.equals("0")&&!product.equals("EJC"))||new Double(sections).doubleValue()==0))){
	%>

...
<table  width='100%' align='center' cellspacing='0' cellpadding='0' border='0'>
	<tr><td class='mainbodyh'>
			...
			else if ((product.equals("GE"))){out.println("The following price is based on furnishing the types, quantities, and sizes listed herein. If ultimate quantities or types deviate from those listed, price is subject to increase or decrease proportionately. All PO's are to be made out to Construction Specialties.");}
			else{

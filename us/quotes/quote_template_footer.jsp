...
if( !((product.equals("BV")) ) ){
if((product.equals("GCP")||product.equals("ELM")||product.equals("APC")||product.equals("GE")||product.equals("SLM")||product.equals("LVR")||product.equals("GRILLE")||product.equals("EFS")||product.equals("IWP"))||(product.equals("EJC") && (sections<2||(section_page!=null&&section_page.equals("1"))))){
...
if (!(tax_perc==null||tax_perc.equals("0"))){
	if(product.equals("ELM")||product.equals("GE")){
		...
		%>
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%=for12x.format(grand_total1-new Double(freight_cost).doubleValue())  %></font>&nbsp;<%=currencyName%></b></td>
	</tr>

	<tr>
		<td class='tableline_row mainbody' width='50%' valign='middle'><B>Freight</b></td>
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%=for12x.format(new Double(freight_cost).doubleValue())  %></font>&nbsp;<%=currencyName%></b></td>
	</tr>
	<tr>
		<td class='tableline_row mainbody' width='50%' valign='middle'><B>Total</b></td>
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%=for12x.format(grand_total1) %></font>&nbsp;<%=currencyName%></b></td>
	</tr>
...
%>
<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'><%=for1.format(new Double(price).doubleValue()) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
else{
...
%>
<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%=for12x.format(new Double(inittotal).doubleValue())  %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<% if(temphandling_cost>0){
%>
<tr>
	<td class='tableline_row mainbody' width='50%' valign='middle'><b>Freight Surcharge</b></td>
	<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b><font class='totprice'>$<%=for12x.format(temphandling_cost)%></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
}
...
//grand_total1=new Double(price).doubleValue();
%>
<td class='tableline_row mainbody' width='75%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for12x.format(grand_total1) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
else {
...
%>
<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for13x.format(new Double(price).doubleValue()) %>.00</font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
else{
%>
<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for13x.format(new Double(grand_total1).doubleValue()) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
}
...
<tr>
	...
	<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>$<%= for12x.format(totalnew) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
...
<td class='tableline_row mainbody' width='50%' align='right' valign='bottom' nowrap><b>Total: <font class='totprice'>$<%= for12x.format(new Double(grand_total1).doubleValue()) %></font>&nbsp;<%=currencyName%></b></td>
</tr>
<%
}
...
out.println("<td class='tableline_row mainbody' width='75%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'>"+for1.format(grand_total1)+"</font>&nbsp;"+currencyName+"</b></td>");
out.println("</tr>");
...
<table width='100%' border='0' style='border-collapse: collapse;' cellspacing='0' cellpadding='2'>
	...
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Address:</td>
	...
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Purchase Order No: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Requested Delivery Date: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
	</tr>
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Customer Name: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Site Phone No:</td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
	</tr>
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Customer Signature: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
	...
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Email Address: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
		<td align='left' valign='bottom' nowrap class='maindesc'></td>
		<td valign='bottom' class='mainbodyh'></td>
	</tr>
	<tr><td></td>
		<td align='left' valign='bottom' nowrap class='maindesc'>Contact Phone No: </td>
		<td valign='bottom' class='mainbodyh'>.....................................</td>
		<td align='left' valign='bottom' nowrap class='maindesc'></td>
		<td valign='bottom' class='mainbodyh'></td>
	</tr>
...
<table cellspacing='0' cellpadding='0' border='0' width='100%'>
	...
	<tr><td ></td><td class='mainfooter'>
			...
			<br>3. Prices are firm against escalation for 30 days from date of this quote, and for shipment within 6 months thereafter. Orders shipped beyond shall be subject to escalation of 0.5% per month for each month or partial month thereafter and invoiced at time of shipment.
			<br>4. The quotation may be withdrawn if not accepted within 30 days of quotation.
			<br><%
			if(session_group_id.startsWith("Decolink")){
				...
				else if(product.equals("GE")) {out.println("Construction Specialties");}
				else if(product.equals("ELM")){ out.println("Elements Commercial Flooring");}
				else{

...
if(pdf==null ||  !pdf.toUpperCase().equals("TRUE")){
	...
	<tr>
	<%
	out.println("<td align='left' width='80%'><img src='http://csimages.c-sgroup.com/eRapid/cs_logo.jpg' alt='CS Logo'></td>");
...
%>
	<table cellspacing='0' cellpadding='0' border='0' width='100%'>
	<%
	out.println("<tr><td align='center' class='maintitle'><b>CS CONSTRUCTION SPECIALTIES COMPANY</b>");
	out.println("<br><font class='subtitle'>");
	out.println("2240 Argentia Rd.<br>Suite 102 Mississauga, Ontario L5N 2K7</font>");
	out.println("<br><font class='subtitle'>Tel: 888-895-8955</font>");
...
<table cellspacing='0' cellpadding='0' border='0' width='100%'>
	...
	<tr>
		...
		out.println("<br><b>CS Estimator: </b>"+estimator+"<BR>");
...
<%
if(type.equals("3")){
	out.println("<BR>We propose to provide the following CS Products at the price quoted and in accordance with the terms and conditions herein.  Such terms and conditions shall form part of any ensuing purchase agreement:  <b> All PO's are to be made out to CS Construction Specialties Company without exception.  <B>");
}
else{
	out.println("<BR>We propose to provide the following CS Products at the price quoted and in accordance with the terms and conditions herein.  Such terms and conditions shall form part of any ensuing purchase agreement:  <b> All PO's are to be made out to CS Construction Specialties Company without exception.  <B>");
}

...
//
ResultSet rs_project = stmt.executeQuery("SELECT Project_name,cust_name FROM cs_project where Order_no like '"+order_no+"' ");
  		if (rs_project !=null) {
...
if (ii<=0){out.println("<p class='pbr'>&nbsp;</p>");}
	...
	*/
	...
	out.println("</form></body></html>");
		...
		URL output_st = new URL("http://"+application.getInitParameter("HOST")+"/custom/orders/efs/shop.transfer.jsp?sp-q="+order_no+"&cmd=1");
		URL output_st1 = new URL("http://"+application.getInitParameter("HOST")+"/custom/orders/efs/shop.transfer.jsp?sp-q="+order_no+"&cmd=2");
		URL output_st2 = new URL("http://"+application.getInitParameter("HOST")+"/custom/orders/efs/shop.transfer.jsp?sp-q="+order_no+"&cmd=3");
		URL output_st3 = new URL("http://"+application.getInitParameter("HOST")+"/custom/orders/efs/shop.transfer.jsp?sp-q="+order_no+"&cmd=4");
		URL output_st10 = new URL("http://"+application.getInitParameter("HOST")+"/custom/orders/efs/shop.transfer.jsp?sp-q="+order_no+"&cmd=10");

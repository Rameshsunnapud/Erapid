...
<TR >
	<TD vAlign=top colspan='2'  width="100%">
	 ...
	 <a href="javascript:show_calendar('calform.due_date');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;">						
     <img src="images/show-calendar.gif" id="imgCalendar2" name="imgCalendar2"  height=22 border=0></a>	 	 
						</td>		
...
<input type="hidden" name="shop_orders" value='<%= shop_orders %>' >					
				...
				<tr><td align='center' valign="top" colspan='3'>&nbsp;</td></tr>						
					...
					<!-- <td align='Right' valign="top" colspan='1'><a href="javascript:n_window('https://<%= application.getInitParameter("HOST")%>/custom/orders/ows/order_transfer_bpcs_home.jsp?order=<%= order_no %>&sections=s1')" class='new' >Transfer Order</a></td> -->
						<td align='right' colspan='2'><a href="javascript:n_window('https://<%= application.getInitParameter("HOST")%>/custom/orders/efs/transfer.jsp?sp-q=<%= order_no %>&cmd=5')" class='new' >Transfer Bills & Routings</a>						
						</td>		
					</tr>		
                                         <%// subhas changes%>

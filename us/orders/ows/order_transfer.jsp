...
//out.println(rep_no+"::"+sfdc_QuoteId+"::"+usession_rep_no+"::"+usession_user_id);
...
String config_price="";String quote_type="";String quote_type2="";String Cust_name="";String commission="";String project_type="";String project_rep_no="",assigned_rep_no="";String project_group_id="";String project_order_rep_no="";
...
String bpcs_order_no="";
        ...
        while (rs_project.next()) {
			 ...
			 if(project_type !=null && project_type.equals("RP")){
				...
				assigned_rep_no=rs_project.getString("assigned_rep_no");
...
//IWP tiers
                        ...
                        ResultSet rs_discount = stmt.executeQuery("Select bpcs_tier from csquotes with (nolock) where order_no like '"+ order_no +"'");
                        if(rs_discount != null){
...
cs_company="DL - CS Senior Living";
}

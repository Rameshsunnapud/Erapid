...
String var="24W996004"; String var2="24U988949S";
String var3="24I820949S"; String var4="24W184004";String var5="24I117949S";
...
java.sql.PreparedStatement query_iim=null;
//ResultSet rs_iim = null;
//variable
...
/*				String sql1=" WITH temp_mbm (parent_part,child_part,qty,seq_no, iteration,usc_code,raw_qty,scrap_factor,op_no,override) AS "+
				       ...
				       "WHERE temp_mbm.child_part = mbm.BPROD and mbm.BMWHS='MU' and mbm.BMBOMM=''"+
				        ...
				        String sql1="select BPROD,BCHLD,BQREQ*"+erapid_quant+",BSEQ,BUSC,BMSCP,BOPNO,BMISS from mbm WHERE bprod = '"+prod.trim()+"' and BMWHS='MU' and BMBOMM=''";
//					out.println(sql1+"<br><br>");//sql statement
 
					ResultSet rs1 = stmt_bpcs.executeQuery(sql1);
					while (rs1.next())  {			
/*						try{
							query_iim = con_bpcs.prepareStatement("select IPROD,IDESC,IREF05 from iim where iprod=? ");
							query_iim.setString(1,rs1.getString (2));
							ResultSet rs_iim = query_iim.executeQuery();							
						while (rs_iim.next())  {
						out.println	("part:"+rs_iim.getString (1)+"desc:"+rs_iim.getString (2)+" IREF05:"+rs_iim.getString (3)+"<br>");
							}
							rs_iim.close();
						} catch (SQLException e) {
							out.println("Problem with ENTERING TO IIM table in BPCS"+"<br>");
							out.println("Illegal Operation try again/Report Error"+"<br>");
							out.println(e.toString());
							return;
						}*/
	//writing this to capture color items ends							
						count++;						

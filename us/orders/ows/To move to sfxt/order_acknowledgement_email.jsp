...
<html>
	...
	<body>
		<%
		try{
		logger.debug("--- Order Acknowledgement Email file Starts --");
	
		String productId=""; String projectName = ""; String creatorId = "";  String userID = "";
		...
		ResultSet csRepsRS=stmt.executeQuery("select rep_name, telephone, email from cs_reps where user_id='"+userID+"' and rep_no='"+creatorId+"'");
		if(csRepsRS != null){
			while(csRepsRS.next()){
		...
		String fromAddress="OrderConfirmed@c-sgroup.com";
	     ...
	     msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toAddress,false));
	   		...
	   		String  messageString = "<!doctype html>"
	   		 		...
	   		 		+ "<head>"
	   		     		...
	   		     		+ "<a href='http://www.c-sgroup.com/'><img src='http://solutions.c-sgroup.com/rs/158-ICN-082/images/cs-logo_email.jpg' width='235' height='34' border='0' style='display:block;' alt='Construction Specialties'/></a>"
	   		     		+ "</td>"
	   		     		+ "</tr>"
	   		     		+ "<!--End Logo-->"
	   		     		+ "<!--Content-->"
	   		     		...
	   		     		+ "<p style='margin-top:0px;margin-bottom:20px;'> This message is to notify you that your order has been received and is being reviewed. We anticipate completing our review  and sending you a formal order acknowledgement within 48 hours."
	   		     		+ "<br>"
	   		     		...
	   		     		+ "<span class='address'>3 Werner Way, Lebanon, New Jersey 08833 | 800.233.8493</span>"
	   		     		+ "</div>"
	   		     		+ "</td>"
	   		     		+ "</tr>"
	   		     		+ "<!--End Footer-->"
	   ...
	   Transport.send(msg);
	   logger.debug("-- Order Acknowledgement Mail method ends --");
	}
	catch(javax.mail.internet.AddressException ae){
		 logger.debug("---OAE file AddressException ");
		System.out.println(ae);
		ae.printStackTrace();
	}
	catch(javax.mail.MessagingException me){
		logger.debug("---OAE file MessagingException ");
		System.out.println(me);
		me.printStackTrace();
	}
	
	catch(Exception e){
		logger.debug("-- OAE file Exception "+e.getMessage());

...
<html>
	...
	String userId=request.getParameter("userId");
		...
		//					config_price= rs_project.getString("configured_price");
					...
					rs_project.close();
                                        freight_cost=""+(new Double(freight_cost).doubleValue()+new Double(handling_cost).doubleValue());
...
/*out.println("284 "+config_price);
out.println("<BR> 284 "+overage);
out.println("<BR> 284 "+handling_cost);
out.println("<BR> 284 "+freight_cost);
out.println("<BR> 284 "+setup_cost);*/

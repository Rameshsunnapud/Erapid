...
<html>
	...
	String userId=request.getParameter("userId");
		...
		String dir_path1="D:\\TRANSFER\\BPCS_OE\\testing\\GE\\";
...
Vector lineComm=new Vector();
		...
		while ( rs3.next() ) {
			...
			//for special shape
			if(rs3.getString("run_cost") != null && rs3.getString("run_cost").trim().length()>0 &&rs3.getString("run_cost").trim().equals("X")&&rs3.getString("product_id").equals("EFS")){
				special_cut="Y";
...
//out.println("2");
		...
		if(product_id.equals("EJC")|product_id.equals("TPG")){
			...
			if(doc_priority.equals("C")){
				//market="TR";//Changed as per latest deployment on 7th 
				market="NT";
			}
			else{
				market="DG";
...
//out.println("3");
		...
		//if(Double.parseDouble(freight_cost)>0){
				...
				final_oi_out=final_oi_out+"IO"+order_no+freight_part+freight_bpcs_qty+freight_cost+"1 "+bpcs_tier_order+"\r\n";
		//}
		//	}
		//}
...
if(lineCommTemp==null || lineCommTemp.equals("")||lineCommTemp.equals("0")){
	...
	//final_oc_out=final_oc_out+"CO"+order_no+com_perc+tot_com_dol_str+overage_str+fc_perc+fc_value+rep_no+"001"+"100000000000"+tot_com_dol_str+overage_perc+overage_str+order_no+" "+quote_type+"000000"+cs_order_type+"100"+"\r\n";
		...
		out.println("Output file created succesfully for eRapid Order... "+order_no+"<br><br><br>");
                ...
                %>
                <%@ include file="order_transfer_bpcs_ge_bom_rou.jsp"%>
                <%

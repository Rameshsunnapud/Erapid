	...
	<BODY bgcolor="whitesmoke">
		...
		<form name="selectform" action="order_page3_save.jsp" onsubmit="return formCheck(this);"  method='post'>
			...
			<table border='0' width='100%'>
				...
				<tr><td  align='right' nowrap ><a href="javascript:showPopup2('http://<%= application.getInitParameter("HOST")%>/docs/iwp/pricing 20guides/Leadtime 20Sheet.xls')" color="navy" face="Arial">SUBMITTAL REQUEST DATE:</a></td>
    ...
    String selected1 = (ship1[i].equals(submit_by)) ? "selected" : "";
		  ...
		  //	out.println(project_type+":::<BR>");
			...
			<table  border='0' width='100%'>
				...
				<tr><td  align='right' ><b><a href="javascript:showPopup2('http://<%= application.getInitParameter("HOST")%>/erapid/us/orders/ows/bpcs_order_arch_search.jsp?mode=3&rep_no=<%= rep_no %>')" color="navy" face="Arial">ARCHITECT'S NAME:</a></b></td>

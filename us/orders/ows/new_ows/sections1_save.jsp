...
try	{
	String insert ="INSERT INTO cs_quote_sections(order_no,sections)VALUES(?,?) ";
...
//			update_cust.setString(2,null);
	...
	try
	{
		int nrow= stmt.executeUpdate("UPDATE cs_quote_sections SET sections="+Integer.parseInt(nfs)+" WHERE order_no ='"+order_no+"'");
	}
	catch (java.sql.SQLException e)
	{

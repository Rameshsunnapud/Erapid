...
<html>
	...
	<body>
		<%
		System.out.println("Order Acknowledgement mail is getting processed with session userId ... "+userId);
		try{
		...
		System.out.println("Logged-in-User is Rep-User ? : "+repUser);
		...
		System.out.println("Dynamic values for the mail are : ");
		System.out.println("Project Name is : "+projectName);
		System.out.println("Order Number is : "+order_no);
		System.out.println("Customer PO Number is : "+customerPoNo);
		System.out.println("CS Representative is : "+csRepresentative);
		System.out.println("Phone is : "+phoneDetails);
		System.out.println("Email is (Also as CC email): "+csRepEmail);
		System.out.println("To Email Address is : "+toAddress);		
	    ...
	    javax.mail.Session mailSession = javax.mail.Session.getInstance(mailProperties, 
		 ...
		 //Commenting below CC address for Test environment !!!!
	   ...
	   Transport.send(msg);
	   System.out.println("-- Order Acknowledgement E-Mail Sent Sucessfully!! for order number : "+order_no+" --");
	   out.println("-- Order Acknowledgement E-Mail Sent Sucessfully!! for order number : "+order_no+" --");
	   
   }else{
	   System.out.println("-- logged in user is cs-internal user or cs-estimator, won't be sending the order acknowledgement mail....--  "+order_no);

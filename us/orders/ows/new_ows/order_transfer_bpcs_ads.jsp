...
String order_type="";
	...
	<h1>CS Order Transfer System::</h1>
		...
		String dir_path1="\\\\lebhq-erusdev\\TRANSFER\\BPCS_OE\\testing\\ADS\\";
		...
		if(overage!= null){
				overage=handling_cost.replaceAll(",","");
		}
...
Vector bpcsNoteLineNo=new Vector();
		...
		ResultSet rs3 = stmt.executeQuery("SELECT * FROM csquotes where order_no like '"+order_no+"' and line_no in ("+lines_final+") and (block_id like 'a_%' or block_id like '%_notes') order by cast(Line_no as integer)");
		while ( rs3.next() ) {
		...
		*/
		...
		ResultSet dNotesRs =  stmt.executeQuery("SELECT Descript, Block_ID FROM csquotes WHERE Order_no like"+ 
...
*/
		...
		dir_path="\\\\lebhq-erusdev\\TRANSFER\\BPCS_BOM\\";String final_bom_out="";String final_rou_out="";dir_path1="\\\\lebhq-erusdev\\TRANSFER\\BPCS_BOM\\test\\ADS\\";
		...
		dir_path="\\\\lebhq-erusdev\\TRANSFER\\BPCS_ROU\\";dir_path1="\\\\lebhq-erusdev\\TRANSFER\\BPCS_ROU\\test\\ADS\\";

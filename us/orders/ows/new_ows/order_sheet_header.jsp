...
out.println("<table border='0px solid black' align='center' cellspacing='0' cellpadding='0' class='tableCSS'>");
out.println("<tr>");
...
if(project_type.equals("PSA")){
	...
	out.println("<td align='center' height='20' class='tdheader' colspan='7'><img src='cs-logo.jpg' alt='CS Logo'><BR>"+type_of_quote+"&nbsp;&nbsp;ORDER SHEET"+"</td>");
}
out.println("</tr>");
...
out.println("</tr>");
out.println("<tr>");
out.println("<td align='right' class='tdOrder' >CUSTOMER PO NUMBER&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
...
out.println("</tr>");
out.println("<tr>");
out.println("<td align='right' class='tdOrder' >TAX EXEMPT NUMBER#&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
...
out.println("<td align='left' class='tdOrder' ><b>&nbsp;</b></td>");
out.println("<td align='right' class='tdOrder' >EMAIL&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
out.println("<td align='left' class='tdOrder' ><b>"+invoice_email+"</b></td>");
out.println("</tr>");
...
out.println("</tr>");
out.println("<tr>");
out.println("<td align='right' class='tdOrder' >DELIVERY NOTICE(HRS)&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
...
out.println("<td><!-- Red Separation Line Goes Here --><div id='Line'></div></td>");
out.println("<td><!-- Red Separation Line Goes Here --><div id='Line'></div></td></tr>");
out.println("<td align='right' class='tdOrder'>"+"OWNER/END USER NAME&nbsp;&nbsp;:&nbsp;&nbsp;</td><td align='left' class='tdOrder'><b>"+eu_cust_name1+" &nbsp;"+eu_cust_no+"</b></td>");
...
out.println("<td><!-- Red Separation Line Goes Here --><div id='Line'></div></td></tr>");
out.println("<tr>");
out.println("<td align='right' class='tdOrder'>"+"ARCHITECT'S FIRM NAME&nbsp;&nbsp;:&nbsp;&nbsp;</td><td align='left' class='tdOrder'><b> "+arch_name+"</b></td>");
out.println("<td  align='right' class='tdOrder'>"+"ADDRESS&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
...
out.println("<td class='tddash' >&nbsp;</b></td>");
out.println("<td align='right' class='tdOrder' >FAX&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
out.println("<td align='left' class='tdOrder'  ><b> "+arch_fax+"</b></td>");
out.println("</tr>");
//out.println("<tr>");

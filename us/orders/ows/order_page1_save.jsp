...
try	{
	...
	PreparedStatement update_customer = myConn.prepareStatement(insert);
			...
			update_customer.setString(9,phone.trim());
...
// just update the customer
	...
	PreparedStatement update_customer = myConn.prepareStatement(insert);
			...
			update_customer.setString(7,phone.trim());
...
if( ! endUserExists){
	try	{
		...
		PreparedStatement update_customer = myConn.prepareStatement(insert);
			...
			update_customer.setString(8,eu_phone.trim());
...
URL yahoo = new URL("https://"+ application.getInitParameter("HOST")+"/erapid/us/orders/ows/order_transfer.jsp?cmd=2&order_no="+order_no+"&id="+rep_no+" ");

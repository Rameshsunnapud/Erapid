...
if(tot_lines>0){
	out.println("<tr>");
	out.println("<td colspan='6'  class='tddashtop' bordercolor='#C0C0C0'>"+"&nbsp; "+product+" Order Information : "+"<td>");
	out.println("</tr>");
	if(project_type != null && (project_type.equals("PSA")||project_type.equals("SFDC")) &&(userGroup.toUpperCase().startsWith("REP")  ) ){
		out.println("<tr><td colspan='6' class='tddash'>PER QUOTE : "+order_no +"<td></tr>");
		...
		out.println("<tr><td class='tddash' colspan='6'>TOTAL PRICE($):&nbsp;<b>"+for1.format(totprice_dis)+"</b></td></tr>");
	}
	else{
		...
		if(project_type != null && project_type.equals("NCP")){
			...
			out.println("<tr>");
			out.println("<td height='30' colspan='2' class='tdheader2'>MODEL</td>");
			out.println("<td height='30' class='tdheader2'>QTY</td>");
			out.println("<td height='30' class='tdheader2'>Unit Price</td>");
			out.println("<td height='30' class='tdheader2'>EXT. PRICE</td>");
			out.println("<td height='30' class='tdheader2'>Comm(%)</td>");
			out.println("</tr>");
			String schedule="";double com_perc=0;String markf="";String gas_color="NONE";
			//  for the schdule
			...
			//out.println("siValue &&&&&&&&&&& : "+sectionString);
						...
						if (((mnValue-1)%2)==1){bgcolor="white";}else {bgcolor="#E7E7E7";}
							...
							if(block_id.elementAt(mnValue-1).toString().equals("C_OPTIONS")){
								...
								if(new Double(quan).doubleValue()>0){
									...
									out.println("<td align='left' class='tdOrder'>&nbsp;"+for1.format(unit_price)+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+for1.format(totprice)+"</td>");
				...
				for (int mn=0;mn<line_item.size();mn++){//if 3
					...
					if ((items.elementAt(k).toString()).equals((line_item.elementAt(mn).toString()))){
						if(block_id.elementAt(mn).toString().equals("C_OPTIONS")){
							...
							if(new Double(quan).doubleValue()>0){
								out.println("<tr>");
								out.println("<td align='left' class='tddash' bgcolor="+bgcolor+">&nbsp;"+description.trim()+"</td>");
								out.println("<td align='center' class='tddash' bgcolor="+bgcolor+">&nbsp;"+quan+"</td>");
								for1.setMaximumFractionDigits(5);
								out.println("<td align='center' class='tddash' bgcolor="+bgcolor+">&nbsp;"+for1.format(unit_price)+"</td>");
								if(project_type.equals("web")){
									for1.setMaximumFractionDigits(2);
									for1.setMinimumFractionDigits(2);
								}
								...
								out.println("<td align='RIGHT' class='tddash' bgcolor="+bgcolor+">&nbsp;"+for1.format(totprice)+"</td>");
								out.println("<td align='RIGHT' class='tddash' bgcolor="+bgcolor+">&nbsp;"+Math.round(com_perc)+"</td>");
								out.println("</tr>");
							}
						}//if 2
					}//if 3
		...
		out.println("<tr>");
		out.println("<td colspan='6'  class='tddashtop' bordercolor='#C0C0C0'>"+"&nbsp; Price Summary : "+"<td>");
		out.println("</tr>");
		out.println("<tr>");
		//totprice_dis=totprice_dis+(new Double(overage).doubleValue())+(new Double(handling_cost).doubleValue())+(new Double(freight_cost).doubleValue());
		out.println("<td class='tddash' >TOTAL PRICE($):</td>");
		out.println("<td class='tddash' ><b>"+for1.format(totprice_dis)+"</b></td>");
		for1.setMaximumFractionDigits(2);
		out.println("<td class='tddash' >Tax:</td>");
		out.println("<td class='tddash' ><b>"+for1.format(tax_dollar)+"</b></td>");
		out.println("<td class='tddash' >OVERAGE AMOUNT($):</td>");
		out.println("<td class='tddash' ><b>"+for1.format(new Double(overage).doubleValue())+"</b></td>");
		for1.setMaximumFractionDigits(0);
		out.println("</tr>");


		out.println("<tr>");
		out.println("<td class='tddash' >FREIGHT SURCHARGE:</td>");
		out.println("<td class='tddash' ><b>"+for1.format(new Double(handling_cost).doubleValue())+"</b></td>");
		out.println("<td class='tddash' >SETUP COST($):</td>");
		out.println("<td class='tddash' ><b>"+"0.0"+"</b></td>");
		out.println("<td class='tddash' >EXTRA CHARGES:</td>");
		out.println("<td class='tddash' ><b>"+for1.format(new Double(freight_cost).doubleValue())+"</b></td>");
		out.println("</tr>");
/*
...
*/
		...
		out.println("<tr>");
		out.println("<td class='tddash' >GRAND TOTAL:</td>");
		out.println("<td class='tddash' ><b>"+for1.format(grandTotal)+"</b></td>");
		out.println("<td class='tddash' >STD.commission:</td>");
		out.println("<td class='tddash' ><b>"+for1.format(factor)+"</b></td>");
		if(project_type != null && project_type.equals("NCP")){
			out.println("<td class='tddash' >STD commission (%):</td>");
		out.println("<td class='tddash' ><b>"+commission+"</b></td>");
		}
		/*else if (prio.equals("E")||prio.equals("D")){
			out.println("<td class='tddash' >STD commission(%):</td>");
		out.println("<td class='tddash' ><b>"+for12.format((factor/((totprice_dis-((new Double(overage).doubleValue())+(new Double(handling_cost).doubleValue())+(new Double(freight_cost).doubleValue())))))*100)+"</b></td>");
		}*/
		else {
			out.println("<td class='tddash' >STD commission(%):</td>");
		out.println("<td class='tddash' ><b>"+for12.format((factor/((totprice_dis-((new Double(overage).doubleValue())+(new Double(handling_cost).doubleValue())+(new Double(freight_cost).doubleValue())))*.91))*100)+"</b></td>");
		}

...
if(queryLines.trim().length()>1){
	...
	//out.println(queryLines+"query lines <BR>"+sections2+"items: "+items);
...
if(sections2 != null && sections2.trim().length()>0 && ! sections2.equals("all")){
	...
	//end overage
		...
		//Below line commented for GJM-227, where calculated setup is not required just price calculator setup will be considered now.
	...
	//Below line commented for GJM-227, where calculated handling_cost is not required just price calculator handling will be considered now.

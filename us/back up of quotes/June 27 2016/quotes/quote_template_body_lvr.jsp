...
//out.println(block_id.elementAt(v).toString()+"::"+desc.elementAt(v).toString()+"::::<BR>");
										...
										if ((block_id.elementAt(v).toString()).equals("A_PRICING")&&desc.elementAt(v)!= null&&desc.elementAt(v).toString().trim().length()>0){
											out.println("<tr width='100%'><td colspan='8' class='mainbody'>"+desc.elementAt(v).toString()+"</td></tr>");
										}
							...
							out.println("<tr width='100%'><td colspan='8' class='mainbody'>"+screen_desc+"</td></tr>");
							out.println("<tr width='100%'><td colspan='8' class='mainbody'>"+finish_desc+"</td></tr>");
							out.println("<tr height='20'>");
							out.println("<td width='12%' bgcolor='#006600' class='schedule'><b><u>Mark</u></b></td>");
							out.println("<td width='12%' bgcolor='#006600' class='schedule'><b><u>Qty</u></b></td>");
							out.println("<td width='13%' bgcolor='#006600' class='schedule'><b><u>Size (W x H)</u></b></td>");
							out.println("<td width='13%' bgcolor='#006600' class='schedule'><b><u>Shape</u></b></td>");
							out.println("<td width='13%' bgcolor='#006600' class='schedule'><b><u>Blank Off</u></b></td>");
							out.println("<td width='13%' bgcolor='#006600' class='schedule'><b><u>Sills</u></b></td>");
							out.println("<td width='12%' bgcolor='#006600' class='schedule'><b><u>Snap on Closure</u></b></td>");
							out.println("<td width='12%' bgcolor='#006600' class='schedule'><b><u>Wind Load</u></b></td>");
							out.println("</tr>");
							out.println("<tr>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+mark.elementAt(n).toString()+"</td>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+for12.format(new Double(qty.elementAt(n).toString()).doubleValue())+"</td>");
							out.println("<td valign='top' nowrap nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+width.elementAt(n).toString()+" x "+height.elementAt(n).toString()+"</td>");
	...
	//						if(shape.trim().length()<=0){shape=" ";}
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+shape+"</td>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+blank_off+"</td>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+sills+"</td>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+snap_ons+"</td>");
							out.println("<td valign='top' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+wind_load.elementAt(n).toString()+"</td>");
							out.println("</tr>");

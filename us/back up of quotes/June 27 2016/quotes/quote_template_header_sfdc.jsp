...
if(canType==null){
	...
	<table cellspacing='0' cellpadding='0' border='0' width='100%'>
		...
		if((group_id.toUpperCase().startsWith("CAN")||canType.equals("CAD")) &&! (product.equals("LVR") || product.equals("GRILLE"))){
...
//Formerly DecoLink Division<br>");
						...
						if(product.equals("GCP")){
							...
							out.println("3 Werner Way<br>");
							out.println("Lebanon, NJ 08833<br>");
							out.println("Tel:908-236-0800 Fax:908-849-4398");
						}
				...
				out.println("Lebanon, NJ 08833<br>");
						...
						out.println("<tr><td align='center' class='maintitle'><b>IMPACT SPECIALTIES, formerly Grand Entrance</b>");
	...
	<table cellspacing='0' cellpadding='0' border='0' width='100%'>
		<tr>
			<td width='55%' valign='top' nowrap class='mainbody'>
				...
				if(! ((product.equals("LVR"))|(product.equals("BV"))|product.equals("ADS")|product.equals("REF")|(product.equals("GRILLE"))|(product.equals("EJC"))|(product.equals("EFS"))|(product.equals("IWP"))|(product.equals("EJC"))|product.equals("GCP")|product.equals("EXP")) ){
...
if(product.equals("IWP")){
	...
	<table cellspacing='0' cellpadding='0' border='0' width='100%'>
		...
		<tr>
			...
			<td nowrap valign='top' align='left' class='mainbody' width='10%'><b>Project:</b>&nbsp;<BR><BR>&nbsp;<BR>&nbsp;<BR><b>Architect:</b>&nbsp;<BR><b>Location:</b>&nbsp;<BR></td>
				...
				out.println("<td width='30%' nowrap valign='top' class='mainbody'><b>"+Project_name+"<br>"+project_city+",&nbsp;"+project_state+"<br><BR>"+Arch_name+"&nbsp;<br>"+Arch_loc);
	...
	if(Arch_state != null && Arch_state.trim().length()>0){
		...
		if( !((product.equals("GE"))|(product.equals("APC"))|(product.equals("LVR"))|(product.equals("BV"))|(product.equals("GRILLE")) |(product.equals("ADS")||product.equals("REF"))  ) ){ %>
		<tr>

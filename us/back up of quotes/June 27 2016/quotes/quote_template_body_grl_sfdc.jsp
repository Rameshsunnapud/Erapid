...
if(sections<=0){
	...
	Vector sch=new Vector();Vector line_product_id=new Vector();
			...
			for (int n=0;n<t_costing;n++){
				if((model_group.elementAt(mn).toString().equals(model.elementAt(n).toString()))&(finish_group.elementAt(mn).toString().equals(finish.elementAt(n).toString()))&(screen_group.elementAt(mn).toString().equals(screen.elementAt(n).toString()))){
					...
					if(bcount==0){
						...
						out.println("<td width='9%' bgcolor='#cccccc' class='schedule'><b><u>Width x Projection</u></b></td>");
						...
						if(isMod || isMyr){
							...
							out.println("<td width='9%' bgcolor='#cccccc' class='schedule'><b><u>Sections</u></b></td>");
							out.println("<td width='9%' bgcolor='#cccccc' class='schedule'><b><u>Corners</u></b></td>");
							out.println("</tr>");							
						}
						else{
							if(!isGen){
						...
						if(!isGen){
							...
							for(int genLine=0; genLine<f1.size(); genLine++){
								...
								out.println("<tr>");
								out.println("<td valign='top' width='5%' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+tempF1+"</td>");
								out.println("<td valign='top' width='5%' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+tempF2+"</td>");
								out.println("<td valign='top' width='5%' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+tempF3+"' x "+tempF4+"'</td>");
								out.println("<td valign='top' width='5%' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+tempF5+"</td>");
								out.println("<td valign='top' width='5%' nowrap bgcolor='"+bgcolor+"' class='maindesc'>"+tempF6+"</td>");
								out.println("</tr>");
							}

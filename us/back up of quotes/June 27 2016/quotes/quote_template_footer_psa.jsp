		...
		*/
			...
			<table cellspacing='0' cellpadding='0' border='0' width='100%'>
				...
				<tr><td class='mainfooter'>
						...
						%>
						<br>1. <%
	if(product.equals("GCP")){out.println("CS Cubicle Curtains Company");} else if(product.equals("GE")) {out.println("Impact Specialties, formerly Grand Entrance");} else {out.println("CS");} %> Standard Terms and Conditions shall apply.
						<%

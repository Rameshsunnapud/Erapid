...
//out.println(secLines+":::"+sectotalname+"<BR>");
	...
	rsCan.close();
String query="select qty,clad_code,stile_code,cost_flag from cs_costing where order_no='"+order_no+"'";
if(secLines != null && secLines.trim().length()>0){
	query="select qty,clad_code,stile_code,cost_flag from cs_costing where order_no='"+order_no+"'and item_no in("+secLines+")";
}
	String tempQty="";

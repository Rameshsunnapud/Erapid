...
<table cellspacing='0' align='center' cellpadding='1' border='0' width='100%'>
	...
	if (((qualifying_notes_free_text.trim()).length()>0)|(qual_count>0)|(product.endsWith("LVR")|product.equals("BV")|product.equals("GCP"))){
		out.println("<BR><tr><td class='mainbodyh'><b>QUALIFYING NOTES:</b></td></tr>");
	}
	if (qual_count>0){
	...
	if (((exclusions_free_text.trim()).length()>0)|(exc_count>0)|(product.endsWith("LVR")|product.equals("BV")|product.equals("GCP"))){out.println("<br><tr><td class='mainbodyh'><b>EXCLUSION NOTES:</b></td></tr>");}
	if (exc_count>0){

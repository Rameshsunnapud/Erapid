<%
	...
	rssum.close();
	out.println("<table border='0' width='100%' align='center'><tr><td><font class='maindesc'>Scope: CS proposes to furnish a total of ("+numLeafs+") 1-3/4\" thick Acrovyn Door leaf(s) as listed herein.</font></td></tr></table><BR>");
	out.println("<table border='1' width='100%' align='center'><tr><td wdith='15%' class='maindesc'><b>Model</b></td><td width='10%' class='maindesc' align='center'><b>Leafs</b></td><td width='75%' class='maindesc'><b>Description</b></td></tr>");
	...
	ResultSet rsb2 = stmt.executeQuery("SELECT linePrice,canLinePrice FROM cs_ads_price_calc WHERE order_no='"+ order_no +"' and model='GLOBAL'");
	if(rsb2 != null){
		while(rsb2.next()){
...
if(exchName.equals("CAD")||exchName.equals("CAN")){
					price1=rsb2.getString("canlinePrice");
				}
				else{
					price1=rsb2.getString("linePrice");
				}
		}
	}
	rsb2.close();
...
<table class='<%= border_color %>' cellspacing='0' cellpadding='0' border='0' width='100%' align='center' height='25'><tr>
		...
		<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'><%= for0.format(new Double(price1).doubleValue()) %>

...
if(sections<=1){
	...
	out.println("<td   class='maindesc'><b><u>Model</u></b></td>");
	...
	if(type.equals("2")){
		...
		out.println("<td width='5%'  class='maindesc'><b><u>Line Total</u></b></td>");
	}
	out.println("</tr>");
	...
	for (int n=0;n<k;n++){
		if(blockId.elementAt(n).toString().toUpperCase().equals("C_OPTIONS")||blockId.elementAt(n).toString().toUpperCase().startsWith("B_CHARGE")){
			...
			out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='left'>"+um.elementAt(n).toString()+"&nbsp;"+"</td>");
			if(type.equals("2")){
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+for1.format(totprice/(new Double(qty2)).doubleValue())+"&nbsp;"+"</td>");
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc'  align='right'>"+for1.format(totprice)+"&nbsp;"+"</td>");
			}
			out.println("</tr>");
			adders=0;
		}
	...
	if((type.equals("2"))){
		...
		if( (new Double(handling_cost)).doubleValue()>0 ){
			out.println("<tr class='table_thin_borders'>");
			out.println("<td valign='top'  bgcolor='"+bgcolor+"' class='maindesc'>"+"Freight Surcharge."+"</td>");
			out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='left' colspan='"+colspan+"'>"+"1"+"</td>");
			String align="right";if(!type.equals("2")){align="left";}
			out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='"+align+"' colspan='"+colspan+"'>"+"EA"+"</td>");
			if(type.equals("2")){
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+"$"+handling_cost+"&nbsp;"+"</td>");
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+"$"+handling_cost+"&nbsp;"+"</td>");
			}
			out.println("</tr>");
		}
		*/
		if( (new Double(freight_cost)).doubleValue()>0 ){
			out.println("<tr class='table_thin_borders'>");
			out.println("<td valign='top'  bgcolor='"+bgcolor+"' class='maindesc'>"+"Special Freight Charge."+"</td>");
			out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='left' colspan='"+colspan+"'>"+"1"+"</td>");
			String align="right";if(!type.equals("2")){align="left";	}
			out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='"+align+"' colspan='"+colspan+"'>"+"EA"+"</td>");
			if(type.equals("2")){
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+""+for1.format(new Double(freight_cost).doubleValue())+"&nbsp;"+"</td>");
				out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+""+for1.format(new Double(freight_cost).doubleValue())+"&nbsp;"+"</td>");
			}
			out.println("</tr>");
		}
	}
...
out.println("<td   class='maindesc' colspan='5'><b><u>Model</u></b></td>");
}
if(type.equals("1")){
out.println("<td width='5%'  class='maindesc' colspan='2'><b><u>Qty</u></b></td>");
out.println("<td width='5%'  class='maindesc' colspan='2'><b><u>UOM</u></b></td>");
}
if(type.equals("2")){
out.println("<td width='5%'  class='maindesc'><b><u>Qty</u></b></td>");
out.println("<td width='5%'  class='maindesc'><b><u>UOM</u></b></td>");
...
if(rsn.getString("block_id").toUpperCase().equals("C_OPTIONS")||rsn.getString("block_id").toUpperCase().startsWith("B_CHARGE")){
	...
	if(type.equals("1") || type.equals("2")){
		...
		out.println("<td valign='top'  bgcolor='"+bgcolor+"' class='maindesc' colspan='5'>"+rsn.getString("Descript")+"</td>");
	}
	if(type.equals("1")){
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' colspan='2'>"+qty2+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='2'>"+rsn.getString("uom")+"&nbsp;"+"</td>");
	}
	if(type.equals("2")){
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc'>"+qty2+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+rsn.getString("uom")+"&nbsp;"+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+for1.format(line_price/(new Double(qty2)).doubleValue())+"&nbsp;"+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc'  align='right'>"+for1.format(line_price)+"&nbsp;"+"</td>");
	}
	out.println("</tr>");
	bcount++;
}//else
...
if( handlingX>0 ){
	...
	out.println("<td valign='top'  bgcolor='"+bgcolor+"' class='maindesc'>"+"Freight Surcharge."+"</td>");
	out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='left' colspan='"+colspan+"'>"+"1"+"</td>");
	out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+"EA"+"</td>");
	if(type.equals("2")){
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+""+for1.format(handlingX)+"&nbsp;"+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+""+for1.format(handlingX)+"&nbsp;"+"</td>");
	}
	out.println("</tr>");
}
if( freightX>0 ){
	...
	out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+"EA"+"</td>");
	if(type.equals("2")){
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right'>"+""+for1.format(freightX)+"&nbsp;"+"</td>");
		out.println("<td valign='top' nowrap width='5%' bgcolor='"+bgcolor+"' class='maindesc' align='right' colspan='"+colspan+"'>"+""+for1.format(freightX)+"&nbsp;"+"</td>");
	}
	out.println("</tr>");
}
}
...
<table class='<%= border_color %>' cellspacing='0' cellpadding='0' border='0' width='100%' height='25'><tr>
	...
	<%
			if(customerCountry.equals("CANADA")){
				out.println("<tr><td class='tableline_row mainbody' colspan='2' valign='middle'>HST Extra   FOB C/S PLANT,  FREIGHT EXTRA</td></tr>");

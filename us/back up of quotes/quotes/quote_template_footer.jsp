...
%>
<td class='tableline_row mainbody' width='50%' align='right' valign='middle' nowrap><b>Total: <font class='totprice'><%= for12x.format(grand_total1) %></font></b></td>
</tr>
<%
}
else {
...
<table cellspacing='0' cellpadding='0' border='0' width='100%'>
	<tr><td class='mainbodyh'>
			<%	if (product.equals("GE")){out.println("");}
					...
					//	out.println("Forward completed & signed acceptance to C/S Representative, name & address as listed in the quotation header above.");
	...
	<tr><td class='mainfooter'>
			...
			<br>1. <%
					...
					if(product.equals("GE")) {out.println("GRAND ENTRANCE");}
			...
			if(session_group_id.startsWith("Decolink")){
				...
				else if(product.equals("GE")) {out.println("GRAND ENTRANCE");}
				else if(product.equals("ELM")){ out.println("Elements Commercial Flooring");}
				else{
			...
			if(isInternational) {
				...
				out.println("<BR>8. Estimated delivery:<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>-If all material is available from stock, 3 weeks shipment ex-factory after receipt of confirming purchase order and release by C/S Credit Dept.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-If all material is not in stock, 7-8 weeks shipment ex factory after receipt of confirming Purchase Order and release by C/S Credit Dept.</i>");
				out.println("<BR>9. For projects located outside the U.S. Construction Specialties requires that all freight forwarders who handle C/S product be C-TPAT certified. Please contact your local representative for more information and a list of available C-TPAT carriers in your area.");

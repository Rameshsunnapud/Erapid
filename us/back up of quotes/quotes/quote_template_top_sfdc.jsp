	...
	<tr><td class='mainbodyh'>
			...
			if ((product.equals("GCP"))){
				if(type.equals("3")){
					...
					out.println("<BR>Proposal based on types and quantities per Fax/Email dated: "+psa_req_date);
				}
			...
			else if ((product.equals("GE"))){out.println("The following price is based on furnishing the types, quantities, and sizes listed herein. If ultimate quantities or types deviate from those listed, price is subject to increase or decrease proportionately. All PO's are to be made out to GRAND ENTRANCE.");}
			else{
...
<table border='0' width='100%' class='table_thin_borders' style='border-collapse: collapse;' cellspacing='0' cellpadding='3'>
	...
	<table border='1' width='100%' class='table_thin_borders' style='border-collapse: collapse;' cellspacing='0' cellpadding='3'>
		...
		if( !(product.equals("LVR")|product.equals("BV")|product.equals("GRILLE")|product.equals("GE")|group_id.startsWith("Decolink")|product.equals("ADS") )){
			//out.println("HERE1");
			...
			if(! ( (psa_alternate==null)||((psa_alternate.trim()).length()<0)) )  {
                            out.println("<tr><td class='mainbodyh' width='20%'><b>Alternate:</b></td><td class='mainbodyh' align='left'>"+ psa_alternate +"</td></tr>");
			}
			if( ! ((psa_addenda==null)||((psa_addenda.trim()).length()<0)) )  {
                            out.println("<tr><td class='mainbodyh' width='20%'><b>Addenda:</b></td><td class='mainbodyh' align='left'> "+  psa_addenda +"</td></tr>");
			}
		}
		else{
			//out.println("HERE2");
			//out.println("HERE2"+sections+"::"+type);
			if(sections<=0||product.equals("LVR")||product.equals("GRILLE")){
				//if(type.equals("3")){
					out.println("<tr><td class='mainbodyh' width='50%'><b>Addenda:</b></td><td align='left' width='50%'> "+lvr_sec_add+"</td></tr>");
					out.println("<tr><td class='mainbodyh' width='50%'><b>Proposal Based on Material as Specified in Section:</b></td><td align='left' width='50%'>"+ lvr_spec_sec +"</td></tr>");
					out.println("<tr><td class='mainbodyh' width='50%'><b>Quantities per Plans Dated:</b></td><td align='left' width='50%'> "+  lvr_sec_date +"</td></tr>");
				// }
			 }
		}
	}
	...
	<table border='1' width='100%' cellspacing='0' cellpadding='3'>
		<%
		out.println("<tr><td class='mainbodyh' width='40%'><b>Addenda:</b></td>");
		if( ! ((psa_addenda==null)||((psa_addenda.trim()).length()<0)) )  {
		...
		out.println("<tr><td class='mainbodyh'><b>Proposal Based on Material as  Specified in Section:</b></td>");
		if(! ((psa_spec_section==null)||((psa_spec_section.trim()).length()<0)) )  {
			out.println("<td class='mainbodyh' align='left'>&nbsp;"+psa_spec_section+"</td></tr>");
		}
		else{
		...
		out.println("<tr><td class='mainbodyh'><b>Quantities per Plans Dated:</b></td>");

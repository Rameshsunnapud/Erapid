...
if(new Double(freight_cost).doubleValue()>0){
	...
	<tr><td class='mainbodyh'>F.O.B. C/S Plant Mississauga, Freight cost included to job site.</td></tr></table><BR>
	<%
}
else{
	%>
	<br>
	<table cellspacing='0' cellpadding='0' border='0' width='100%'>
	<tr><td class='mainbodyh'>F.O.B. C/S Plant Mississauga, Freight cost extra.</td></tr></table><BR>
	<%
}
%>

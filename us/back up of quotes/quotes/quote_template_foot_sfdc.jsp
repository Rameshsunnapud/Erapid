...
if(product.equals("EJC")){
	if(addSFDC != null && addSFDC.trim().length()>0){
		out.println("<tr><td class='mainbodyh'><BR><b>ADD OPTIONS:</b></td></tr>");
		out.println("<tr><td class='mainbodyh'>"+addSFDC);
		out.println("</td></tr>");
	}
	if(deductSFDC != null && deductSFDC.trim().length()>0){
		out.println("<tr><td class='mainbodyh'><BR><b>DEDUCT OPTIONS:</b></td></tr>");
		out.println("<tr><td class='mainbodyh'>"+deductSFDC);
		out.println("</td></tr>");
	}
}

				...
				if(!group_id.startsWith("Internatio")&!type.equals("5")&!type.equals("6")) {
					if(product.endsWith("IWP")){
						...
						if(group_id.startsWith("Decolink")){
							out.println("<td width=50% class='mainbodyh' align='left'><b>Estimator:</b>"+sfdc_estimator+"</td>");
						}else{
		...
		*/
			...
			<table cellspacing='0' cellpadding='0' border='0' width='100%'>
				...
				<tr><td class='mainfooter'>
						...
						%>
						<br>1. <%
	if(product.equals("GCP")){out.println("C/S Cubicle Curtains Company");} else if(product.equals("GE")) {out.println("GRAND ENTRANCE");} else {out.println("C/S");} %> Standard Terms and Conditions shall apply.
						<%

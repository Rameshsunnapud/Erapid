...
else if ((product.equals("GE"))){out.println("The following price is based on furnishing the types, quantities, and sizes listed herein. If ultimate quantities or types deviate from those listed, price is subject to increase or decrease proportionately.<b> All PO's are to be made out to GRAND ENTRANCE.</b>");}
else{

...
<!-- Begin
	...
	<div name='main'>
		...
		if(request.getParameter("env") != null && !request.getParameter("env").isEmpty()){
		 	env_var = request.getParameter("env");			
	    }	
		...
		<center>
			...
			if(!group.toUpperCase().startsWith("REP") && (product_name.equals("FSM")||product_name.equals("LVR")||product_name.equals("GRILLE")||product_name.equals("SUN")||product_name.equals("BV"))){
				out.println("<input type='hidden' name='access_central' value='y'  >");
			}
			...
			if(product_name.equals("FSM")|product_name.equals("LVR")|product_name.equals("GRILLE")|product_name.equals("SUN")|product_name.equals("ADS")|product_name.equals("DADE_LVR")|product_name.equals("BV")){
			//out.println("HERE12");
				//boolean goodToGo=false;
		...
		if(sectionsGood){
				...
				if(numberOfSections == 0||sectionInfo == null ||sectionInfo.trim().length()<1){
					...
					if(product_name.equals("ADS")){
						...
						out.println("<input type='button' class='button' name='Price Calculator' value='Price Calculator' onclick=m_window('https://"+ application.getInitParameter("HOST")+"/erapid/us/legacy/ads_price_calc.jsp?q_no="+ order_no+"&product="+ product_name+"')>");
				%>
				<!--<font face="Arial" color="#003000"><B><a href="javascript:m_window('https://<%= application.getInitParameter("HOST")%>/erapid/us/legacy/ads_price_calc.jsp?q_no=<%= order_no%>&product=<%= product_name%>')">Price Calculator</a> <font face="Arial" color="navy"></font>-->
			<%
		}
		else{
			if(!group.toUpperCase().startsWith("REP")){
				out.println("<input type='button' class='button' name='Price Calculator' value='Price Calculator' onclick=m_window('https://"+application.getInitParameter("HOST")+"/erapid/us/legacy/access_central.jsp?q_no="+ order_no+"&product="+product_name+"')>");

			%>
			<!--<font face="Arial" color="#003000"><B><a href="javascript:m_window('https://<%= application.getInitParameter("HOST")%>/erapid/us/legacy/access_central.jsp?q_no=<%= order_no%>&product=<%= product_name%>')">Price Calculator</a> <font face="Arial" color="navy"></font>-->
			<%
			}
			else{
				out.println("You have reached this page on error.  Please report error to the erapid team.");
			}
		...
		for(int y=0; y<numberOfSections; y++){
			...
			if(!group.toUpperCase().startsWith("REP")){
				out.println("<input type='button' class='button' name='Price Calculator' value='Price Calculator' onclick=m_window('https://"+ application.getInitParameter("HOST")+"/erapid/us/legacy/access_central.jsp?q_no="+ order_no+"&product="+product_name+"&section="+(y+1)+"&section_name="+sectionNames[y].replaceAll(" ","%")+"')> for section &quot"+sectionNames[y]+"&quot<BR>");
				//out.println("<BR>http://"+ application.getInitParameter("HOST")+"/erapid/us/legacy/access_central.jsp?q_no="+ order_no+"&product="+product_name+"&section="+(y+1)+"&section_name="+sectionNames[y]+"<BR>");
			%>
			<!--http://<%= application.getInitParameter("HOST")%>/erapid/us/legacy/access_central.jsp?q_no=<%= order_no%>&product=<%= product_name%>&section=<%=y+1%>&section_name=<%=sectionNames[y]%>
			<BR>
			<font face="Arial" color="#003000"><B><a href="javascript:m_window('https://<%= application.getInitParameter("HOST")%>/erapid/us/legacy/access_central.jsp?q_no=<%= order_no%>&product=<%= product_name%>&section=<%=y+1%>&section_name=<%=sectionNames[y]%>')">4Price Calculator</a> for section "<%=sectionNames[y]%>" <font face="Arial" color="navy"></font> <BR>-->
			<%
			}
			else{
				out.println("You have reached this page on error.  Please report error to the erapid team.");
	...
	if(product_name.equals("ADS")){
		...
		out.println("<input type='button' class='button' name='Tear Sheets' value='Tear Sheets' onclick=m_window2('../reports/ads_tear_sheet.jsp?orderNo="+order_no+"&username="+name+"')><BR>");
			...
			%><tr><td colspan='2'>
					...
					<%
					//out.println(group);
					if(project_typex.equals("SFDC")){
						//out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
						//out.println("<input type='button' class='button' name='Summary report' value='Summary report' onclick=m_window2('../reports/display_test_new1.jsp?choice="+ order_no+"')><BR>");
						//out.println("</td></tr>");
						//out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
						//out.println("<input type='button' class='button' name='Send to PSA' value='Send to PSA' onclick=m_window2('psa1.jsp?order_no="+ order_no+"')><BR>");
						//out.println("</td></tr>");
					}

					else{
						if(!group.toUpperCase().equals("INTERNAT_Q")){
							out.println("<input type='button' class='button' name='Send to PSA' value='Send to PSA' onclick=m_window2('../reports/psa1.jsp?order_no="+ order_no+"')><BR>");
							out.println("</td></tr>");
							out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
							out.println("<input type='button' class='button' name='Send to PSA Training' value='Send to PSA Training' onclick=m_window2('../reports/psa2.jsp?order_no="+ order_no+"')><BR>");
							out.println("</td></tr>");
						}
						else{
							out.println("<input type='button' class='button' name='International LVR Quote' value='International LVR Quote' onclick=m_window2('../quotes/show_intl_quote.jsp?order_no="+ order_no+"')><BR>");
							out.println("</td></tr>");
						}
						//out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
						//out.println("<input type='button' class='button' name='Summary report' value='Summary report' onclick=m_window2('../reports/display_test_new1.jsp?choice="+ order_no+"')><BR>");
						//out.println("</td></tr>");
						//out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font><form name='formPDF' action='pdf.jsp' method='post'>");
						//out.println("<input type='button' class='button' name='Summary report PDF' value='Summary report PDF' onclick='goPdf()'>");
						out.println("<input type='hidden' name='order_no' value='"+order_no+"'>");
						out.println("<input type='hidden' name='url' value='http://"+ application.getInitParameter("HOST")+"/erapid/us/reportsy/display_test_new1.jsp?choice="+ order_no+"'>");
						//out.println("</form></td></tr>");
					}
                                        
                                        
if(name.equals("aaron")||name.equals("aweeks")||name.equals("awiener")||name.equals("calilimo")||name.equals("es_admin")||name.equals("esom")||name.equals("esomtb")||name.equals("pbilanyc")){
out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
						out.println("<input type='button' class='button' name='Old Summary report' value='Old Summary report' onclick=m_window2('../reports/display_test_new1.jsp?choice="+ order_no+"')><BR>");
						out.println("</td></tr>");    

}
						out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
						out.println("<input type='button' class='button' name='Summary report' value='Summary report' onclick=m_window2('../reports/cranSummaryReport.jsp?orderNo="+ order_no+"')><BR>");
						out.println("</td></tr>");
					...
					out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
					out.println("<input type='button' class='button' name='Schedule of Values' value='Schedule of Values' onclick=m_window2('../reports/sch_final.jsp?choice="+ order_no+"')><BR>");
					out.println("</td></tr>");
out.println("<tr><td colspan='2'><font size='1'>&nbsp;<br></font>");
		out.println("<input type='button' class='button' name='Tear Sheets' value='Tear Sheets' onclick=m_window2('../reports/tear.home.jsp?orderNo="+order_no+"&username="+name+"&pid=1')><BR>");

out.println("<input type='button' class='button' name='Tear Sheets' value='Tear Sheets PDF' onclick=m_window2('http://"+ application.getInitParameter("HOST")+"/erapid/us/documentGenerator.jsp?orderNo="+order_no+"&urlx=reports/tear.home.jsp&urlAddx=!pid@1&action=pdf&imstype=null#')><BR>");
out.println("</td></tr>");
					//"+for1.format(d1.doubleValue())+"&total="+d2+"')>");
					%>
				</td></tr>
				<%
			}
	...
	//}
	//out.println("TEST THIS::"+q_no+"::"+sfdc_QuoteId+"::");
	if(project_typex.equals("SFDC")&&goodToGo){
				...
				<%
					if(application.getInitParameter("HOST").toUpperCase().indexOf("DEV")>0){
						if(env_var.equalsIgnoreCase("sit")){
							out.println("<tr><td align='left'><a href='https://c-sgroup--sit.my.salesforce.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a>	</tr>");
						}else if(env_var.equalsIgnoreCase("UAT")){
							out.println("<tr><td align='left'><a href='https://c-sgroup--uat.my.salesforce.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a>	</tr>");
						}else if(env_var.equalsIgnoreCase("maya") || env_var.equalsIgnoreCase("dev")){
		                   out.println("<tr><td align='left'><a href='https://c-sgroup--dev.my.salesforce.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a>	</tr>");
						}else{
		                    out.println("<tr><td align='left'><a href='https://c-sgroup--dev.my.salesforce.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a>	</tr>");
						}
						//out.println("<tr><td align='left'><a href='https://c.cs3.visual.force.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a>	</tr>");
					}
					else{
						out.println("<tr><td align='left'><a href='https://na44.salesforce.com/apex/CSQuoteLineProcessing?sfQuoteId="+sfdc_QuoteId+"1' target='_top' ><img border='0' src='../../images/sfdc_image1.jpg'></a></tr>");
					}
out.println("</table");
			}
...
return true;">--><b>Section Free Notes <%=desc_count%>:</b></A></td>
						...
						//  END OF CODE EDITED BY GREG
							...
							if(product_name.equals("EFS")||product_name.equals("GCP")){
								desc_count=0;var="";
								for(int i=0;i<sections;i++){
									desc_count=i+1;
									var="s"+desc_count+"=";
			...
			<form name='notesForm'><input type='hidden' name='secNo'>
				<table width='90%'>
					<tr>
						...
						<td  valign='top'><%=quoteHeader.getNotes(product_name,"exclusion") %></td>
					</tr>
					<tr><td colspan='3'>&nbsp;</td></tr>
					<tr>
						<td valign='top'>Qualifying</td>
						<td valign='top'><%=quoteHeader.getNotes(product_name,"qualify") %></td>
					</tr>
					<tr><td colspan='3'>&nbsp;</td></tr>

	...
	<SCRIPT LANGUAGE="JavaScript">
		...
		try{
			function checkCanada(hrrate,enghrrate,pmhrrate){
				...
				//alert("HERE"+document.displayForm.exportCrate.value*1+"::"+document.displayForm.city.value+"::"+document.displayForm.state.value);
			...
			function endScript(){
				...
				if(document.displayForm.pIndTOTWT.value==0){
					...
					pIndYIELD=(document.displayForm.pInfSELLPRICE.value*1/((document.displayForm.pIndTOTWT.value*1-document.displayForm.pInfCATCHALLWT.value*1)+document.displayForm.pInfCATCHALLWT.value*1.05)*100.0)/100.0;
			...
			function weightChange(){
				...
				if(document.displayForm.manualFreight.value!="Y"){
					//alert("FREIGHT CHANGE");
					
					//alert("GSO pIndTOTWT : " +document.displayForm.pIndTOTWT.value);
					//alert("GSO city : " +document.displayForm.city.value);
					//alert("GSO state : " +document.displayForm.state.value);
			...
			function weightChange2(searchXML){
				...
				//alert("GSO pInfFREIGHT : " +document.displayForm.pInfFREIGHT.value);
			...
			function x(){
				var yeild=0;
				yeild=document.displayForm.pInfSELLPRICE.value/((document.displayForm.pIndTOTWT.value*1-document.displayForm.pInfCATCHALLWT.value*1)+document.displayForm.pInfCATCHALLWT.value*1.05);
				document.displayForm.pIndYIELD.value=yeild.toFixed(2);
				//alert("Yield = "+yeild);
			...
			function calcProject(){
				//alert("THIS USES SUBTOTAL SHOWING RIGHT ABOVE COMMISSION.  NOT SURE IF THIS IS CORRECT YET");
			...
			function roundCanada(){
				...
				//alert(roundCan);
				//document.displayForm.pInfSELLPRICE.value
				//document.displayForm.exchRate.value;
			...
			function addFasteners(){
				//alert("add some fasteners::"+document.displayForm.pIndMATLESSFIN.value+"::"+document.displayForm.pIndTOTWT.value);
		...
		if(city.equals("Honolulu") && state.equals("HI")){
			for(int x=0; x<VI_MAX_SUBLINE; x++){
				if(SYSDEPTH[x]!=null && SQFT[x]!=null){
					...
					pInfFREIGHT=pInfFREIGHT+(((tempSysDepth/12)*new Double(SQFT[x]).doubleValue())*6.5);
				}
			}
		}
	}

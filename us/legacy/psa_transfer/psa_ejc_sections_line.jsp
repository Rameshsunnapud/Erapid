		...
		try
			{
				...
				String stat1="";
				if(sections==0){
				stat1="select * from csquotes where order_no='"+order_no+"' and Block_ID ='PRICING' and Sequence_no='0.00' and cast(extended_price as decimaL)>0 order by cast(Line_no as integer),cast(Extended_Price as decimal)" ;
				}
				else{
				stat1="select (select sum(cast(extended_price as decimal)) from csquotes where order_no='"+order_no+"' and Block_ID ='PRICING' and Sequence_no='0.00' and cast(extended_price as decimal)>0 and line_no in("+sect_group_lines.elementAt(ye).toString()+")),* from csquotes where order_no='"+order_no+"' and Block_ID ='PRICING' and Sequence_no='0.00' and cast(extended_price as decimal)>0 and line_no in("+sect_group_lines.elementAt(ye).toString()+") order by cast(Line_no as integer),Extended_Price";
				}

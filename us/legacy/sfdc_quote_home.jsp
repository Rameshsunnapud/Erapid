...
%>
<a href="javascript:n_window2('https://<%=application.getInitParameter("HOST")%>/erapid/us/quotes/sections.home.jsp?q_no=<%=q_no%>&cmd=1&close=true')"><FONT SIZE='2'><b>Quote Sections</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<%
